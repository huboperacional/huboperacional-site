...
- **Próximo passo imediato (retomada):** TUDO da sessão 2026-07-14 está `[5-T]` em prod (`v0.3.4` no ar): v0.3 /new-client, SEO v0.2, Playwright E2E, **OG image**, **GA4+consent**. Tag `v0.3.3` criada — **considerar criar tag git `v0.3.4`** (imagem prod já é v0.3.4). Backlog restante: **(1) conteúdo definitivo dos 8/9 produtos** — curadoria do operador (hoje placeholder, parte sem acento; afeta também o texto das OG images). **(2) Meta Pixel** — adiado pelo operador. **(3) canon divergente** (`6.26.1` vs `6.28.0`) — considerar REORGANIZAR antes de trabalho grande. Nenhum bloqueio ativo.
