...
- `[4-C]` Side-effect append na planilha **"V4 Clientes"** — `integrations/googleSheets.py`, flag `google_sa_json`. **SA já injetado** (reusa `plexco-backend-invoker@plexco-media-2026.iam.gserviceaccount.com`). **BLOQUEADO no Google:** (1) habilitar Sheets API no projeto `538510710999` (dá 403); (2) compartilhar planilha V4 (Editor) com esse e-mail. Feito isso, ativa sem redeploy. Ver HANDOFF.
